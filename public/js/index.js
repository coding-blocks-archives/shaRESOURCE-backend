      ...
      for (let i = 0; i < blocks.data.length; i++) {
        ...
        blockList.append(`<li class="minicourses-list-li col-12" style="height: auto">
                <div class="minicourses-list-li-div">
                    ...
                    <p>Time: ` + blocks.data[i].timestamp + `<br>Username: ` + blocks.data[i].data.user + `<br>Amount: ` + blocks.data[i].data.amount + `<br>Current Hash: ` + blocks.data[i].hash + `<br>Previous Hash: ` + blocks.data[i].previousHash + `</p>
                    </div>
                </div>
            </li>`)
      }
